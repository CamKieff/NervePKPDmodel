...
#File1
init_params <- c(KAach = 2.6334, #ach model parameters
                 KEach = 1.2737,
                 DVach = 6.0002,
...
Iteration(con_list=1, freq_list = c(0.3,0.7,1,3,7,10,15,30), n=100, ITmodel = thismodel, bestfit = c("m2max", "chemax", "IC50m2","IC50che"),
          init_params=init_params, hyperparams = c(4, 0.5), filename = "FormattedLowerTrachea/control/complexResults_")

#File2
init_params <- c(KAach = 1.061339, #ach model parameters
                 KEach = 1.7173,
                 DVach = 5.99345,
                 EC50ach = 5.383, #calculated from ACH constriction curves of isolated tracheas
...
#File5
init_params <- c(KAach = 2.5551, #ach model parameters
                 KEach = 1.4658,
                 DVach = 6,
                 EC50ach = 5.383, #calculated from ACH constriction curves of isolated tracheas
...
Iteration(con_list=5, freq_list = c(0.3,0.7,1,3,7,10,15,30), n=100, ITmodel = thismodel, bestfit = c("m2max", "chemax", "IC50m2","IC50che"),
          init_params=init_params, hyperparams = c(4, 0.5), filename = "FormattedLowerTrachea/control/complexResults_")
#File7
init_params <- c(KAach = 2.8693, #ach model parameters
                 KEach = 1.007,
                 DVach = 6,
                 EC50ach = 5.383, #calculated from ACH constriction curves of isolated tracheas
